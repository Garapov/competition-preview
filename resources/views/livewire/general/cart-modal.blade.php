                ...
                <div class="general__modal_in" wire:click.outside="closeModal">
                    <div class="general__modal_top">
                        <div class="general__modal_tabs">
                            <div class="general__modal_tab" :class="{'general__modal_tab--active': activeTab == 'online'}" @click="activeTab = 'online'">Online entry</div>
                            <div class="general__modal_tab" :class="{'general__modal_tab--active': activeTab == 'postal'}" @click="activeTab = 'postal'">free postal entry</div>
                        </div>
                        <div class="general__modal_close" wire:click="closeModal">
                            <img src="{{ asset('assets/images/close.svg') }}" alt="">
                        </div>
                    </div>
                    <div class="general__modal_middle" x-show="activeTab == 'online'">
                        <div class="modal_product">
                            <div class="modal_product__left">
                                <img :src="raffle.image" alt="">
                            </div>
                            <div class="modal_product__right">
                                <div class="modal_product__name" x-text="raffle.name"></div>
                                <div class="modal_product__price_wrap">
                                    <template x-if="raffle.discount_price">
                                        <div class="modal_product__oldprice">
                                            <div class="left" x-text="'£'+raffle.price"></div>
                                        </div>
                                    </template>
                                    <div class="modal_product__price">
                                        <template x-if="raffle.discount_price">
                                            <div class="left" x-text="'£'+raffle.discount_price"></div>
                                        </template>
                                        <template x-if="!raffle.discount_price">
                                            <div class="left" x-text="'£'+raffle.price"></div>
                                        </template>
                        ...
                        <div class="modal_amount">
                            <div class="modal_amount__left">
                                ...
                                <div class="modal_amount__count">
                                    <input type="number" min="1" x-model="count" @change="validateCount">
                                </div>
                        ...
                        <div class="modal_select">
                            ...
                            <div class="modal_select__items">
                                <div class="modal_select__item" :class="{ 'modal_select__item--selected': count == 20 }" @click="quickSelect(20)">
                                    <div class="count">20</div>
                                    <div class="caption">tickets</div>
                                </div>
                                <div class="modal_select__item" :class="{ 'modal_select__item--selected': count == 100 }" @click="quickSelect(100)">
                                    <div class="count">100</div>
                                    <div class="caption">tickets</div>
                                </div>
                                <div class="modal_select__item" :class="{ 'modal_select__item--selected': count == 300 }" @click="quickSelect(300)">
                                    <div class="count">300</div>
                                    <div class="caption">tickets</div>
                                </div>
                                <div class="modal_select__item modal_select__item--best" :class="{ 'modal_select__item--selected': count == 600 }" @click="quickSelect(600)">
                        ...
                        <div class="modal_button">
                            <button class="modal_button__add" @click="addToCart">
                                ADD TO BASKET
                            </button>
                        </div>
                    </div>
                    <div class="general__modal_text" x-show="activeTab == 'postal'">
                        <strong>
