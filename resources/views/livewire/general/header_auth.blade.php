    ...
    @if (!$user)
        <div class="header__auth-block header__auth-login">
            ...
            @if ($isLoginFormOpened)
                <form wire:submit.prevent="login" class="header__auth-popup" @click.outside="$wire.closeLoginForm()">
                    <div class="header__auth-title">Log in</div>
                    <div class="header__auth-form">
                        <input class="header__auth-input" type="email" placeholder="Email" wire:model="email">
        ...
        <div class="header__auth-block header__auth-register">
            ...
            @if ($isRegisterFormOpened)
                <form wire:submit.prevent="register" class="header__auth-popup" @click.outside="$wire.closeRegisterForm()">
                    ...
                    <div class="header__auth-form">
                        ...
                        <input class="header__auth-input" type="date" placeholder="DD-MM-YYYY" wire:model="born">
                        @error('born') <span class="error">{{ $message }}</span> @enderror

                        <input class="header__auth-input" type="email" placeholder="Email *" wire:model="new_email">
